...
global.__grid_old_track_event = {
  "brush_grid_old_channel": function(data) {
  ...
  "brush_grid_old_coin": function(data) {
    var controller = Beans.get(BeanVisuController)
  ...
  "brush_grid_old_config": function(data) {
    var controller = Beans.get(BeanVisuController)
  ...
  "brush_grid_old_particle": function(data) {
  ...
  "brush_grid_old_player": function(data) {
    var controller = Beans.get(BeanVisuController)
    var json = {
  ...
  "brush_grid_old_separator": function(data) {
    var controller = Beans.get(BeanVisuController)
